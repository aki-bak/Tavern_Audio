...
//        FootstepsSound.set3DAttributes(FMODUnity.RuntimeUtils.To3DAttributes(gameObject.transform)); // Przypięcia emitter eventu do obiektu GameObject. dodac to lepiej!
